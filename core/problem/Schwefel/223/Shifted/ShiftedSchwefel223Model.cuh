...
#ifndef PARALLELLBFGS_SHIFTEDSCHWEFEL223MODEL_CUH
#define PARALLELLBFGS_SHIFTEDSCHWEFEL223MODEL_CUH

#include "../../../../optimizer/operators/perturb/Perturbator.h"
#include "../../../../common/Metrics.cuh"
#include "ShiftedSchwefel223.cuh"
#include <math.h>

#ifdef PROBLEM_SHIFTED_SCHWEFEL223
class ShiftedSchwefel223Model: public Model {
    std::mt19937 generator=std::mt19937(std::random_device()());
    Residual SchwefelResidual[1]{};
public:

    ShiftedSchwefel223Model():Model(){};
    explicit ShiftedSchwefel223Model(Perturbator& perturbator) : Model(perturbator.populationSize,X_DIM) {
        residuals.residualCount=1;
        SchwefelResidual[0].constantsCount=X_DIM;
        SchwefelResidual[0].constantsDim=2;
...
#define DEFINE_RESIDUAL_FUNCTIONS() \
        ShiftedSchwefel223 f1 = ShiftedSchwefel223();
...
#define CAST_RESIDUAL_FUNCTIONS() \
        ShiftedSchwefel223 *f1 = ((ShiftedSchwefel223 *) model->residuals.residual[0].residualProblem);
...
#endif //PARALLELLBFGS_SHIFTEDSCHWEFEL223MODEL_CUH
