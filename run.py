...
def runSNLP3D(problemPath,problemName,anchorName,residualSizes,modelsize,framesize):
...
def runSNLP2D(problemPath,problemName,anchorName,residualSizes,modelsize,framesize):
