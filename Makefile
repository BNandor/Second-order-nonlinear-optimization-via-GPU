...
test-rosenbrock:
	/usr/local/cuda-11.4/bin/nvcc main.cu  -g -G  -DOPTIMIZER=GD           -DSAFE      -DPROBLEM_ROSENBROCK                          -DFRAMESIZE=400                   -DGLOBAL_SHARED_MEM -DITERATION_COUNT=1000 -DPOPULATION_SIZE=30 -DPRINT -DX_DIM=1000 -o gd -arch=sm_60  -Xptxas -v  && ./gd

#http://www.sfu.ca/~ssurjano/stybtang.html min -39.165d
test-styblinskitang: 
	/usr/local/cuda-11.4/bin/nvcc main.cu  -g -G  -DOPTIMIZER=GD            -DSAFE     -DPROBLEM_STYBLINSKITANG                          -DFRAMESIZE=400                   -DGLOBAL_SHARED_MEM -DITERATION_COUNT=1000 -DPOPULATION_SIZE=30 -DPRINT -DX_DIM=100 -o gd -arch=sm_60  -Xptxas -v  && ./gd
...
test-qing: 
	/usr/local/cuda-11.4/bin/nvcc main.cu  -g -G  -DOPTIMIZER=GD              -DSAFE   -DPROBLEM_QING                         -DFRAMESIZE=400                   -DGLOBAL_SHARED_MEM -DITERATION_COUNT=10000 -DPOPULATION_SIZE=30 -DPRINT -DX_DIM=1000 -o gd -arch=sm_60  -Xptxas -v  && ./gd
