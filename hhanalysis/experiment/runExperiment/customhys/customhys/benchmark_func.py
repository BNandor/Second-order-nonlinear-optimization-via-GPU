...
class PROBLEM_MICHALEWICZ(BasicProblem):
    def __init__(self, variable_num):
        super().__init__(variable_num)
        self.max_search_range = np.array([math.pi,] * self.variable_num)
        self.min_search_range = np.array([0.] * self.variable_num)
        self.optimal_solution = np.array([0.] * self.variable_num)
        self.global_optimum_solution = 0.
        self.func_name = 'PROBLEM_MICHALEWICZ'
        self.features = {'Continuous': True,
                         'Differentiable': True,
                         'Separable': True,
                         'Scalable': True,
    ...
    def get_func_val(self, variables, *args):
        D = len(variables)
        i = np.arange(1, D + 1)
        return-np.sum(np.sin(variables) * np.sin(((i * variables**2) / np.pi))**(20))

class PROBLEM_DIXONPRICE(BasicProblem):
    def __init__(self, variable_num):
        super().__init__(variable_num)
        self.max_search_range = np.array([10,] * self.variable_num)
        self.min_search_range = np.array([-10.] * self.variable_num)
        self.optimal_solution = np.array([pow(2.0,-(pow(2.0,i)-2.0)/pow(2,i)) for i in range(1,variable_num+1)])
        self.global_optimum_solution = 0.
        self.func_name = 'PROBLEM_DIXONPRICE'
        self.features = {'Continuous': True,
                         'Differentiable': True,
                         'Separable': True,
                         'Scalable': True,
...
class PROBLEM_SCHWEFEL(BasicProblem):
    def __init__(self, variable_num):
        super().__init__(variable_num)
        self.max_search_range = np.array([500.] * self.variable_num)
        self.min_search_range = np.array([-500.] * self.variable_num)
        ...
        self.global_optimum_solution = 0.
        self.func_name = 'PROBLEM_SCHWEFEL'
        self.features = {'Continuous': True,
                         'Differentiable': True,
                         'Separable': True,
                         'Scalable': True,
...
class PROBLEM_SUMSQUARES(BasicProblem):
    def __init__(self, variable_num):
        super().__init__(variable_num)
        self.max_search_range = np.array([5.12] * self.variable_num)
        self.min_search_range = np.array([-5.12] * self.variable_num)
        self.optimal_solution = np.array([0.] * self.variable_num)
        self.global_optimum_solution = 0.
        self.func_name = 'PROBLEM_SUMSQUARES'
        self.features = {'Continuous': True,
                         'Differentiable': True,
                         'Separable': True,
                         'Scalable': True,
...
class PROBLEM_SPHERE(BasicProblem):
    def __init__(self, variable_num):
        super().__init__(variable_num)
        self.max_search_range = np.array([5.12] * self.variable_num)
        self.min_search_range = np.array([-5.12] * self.variable_num)
...
class Schwefel226(BasicProblem):
    ...
    def get_func_val(self, variables, *args):
        return 418.983*self.variable_num - np.sum(variables * np.sin(np.abs(variables))) 
