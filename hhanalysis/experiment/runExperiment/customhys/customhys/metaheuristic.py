...
class Metaheuristic:
    ...
    """
    def __init__(self, problem, search_operators, num_agents=30, num_iterations=100,currentEvaluations=0,label=''):
        """
        ...
        self.pop.evaluations=currentEvaluations
    ...
    def run(self):
        ...
        if self.pop.evaluations%5000==0:
            print(f"{self.label}:{self.pop.evaluations}")
        ...
        for iteration in range(1, self.num_iterations + 1):
            ...
            for operator, selector in zip(self.operators, self.selectors):
                ...
                # print('Operators.' + operator_name + '(self.pop,' + operator_params)
                # print(f"Rosenbrock evals:{self.pop.evaluations}")
                # Evaluate fitness values
                self.pop.evaluate_fitness(self._problem_function)
