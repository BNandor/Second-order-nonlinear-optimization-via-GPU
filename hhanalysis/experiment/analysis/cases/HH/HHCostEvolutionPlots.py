...
methods=[     
                  ...
                  (BIGSA_CMA_ES_GA_DE_GD_LBFGS_GWO_EXPERIMENT_RECORDS_PATH,"BIGSA-CMA-ES-GWO",{}),
...
dimensions=[5,50,100,750]
performanceMapping=lambda trial: trial['med_+_iqr']
filter=[('baseLevelEvals',[100]),('baseLevel-xDim',dimensions)]

createMethodsCostEvolutionPlots(methods,problems,performanceMapping,filter,filename=f'{ROOT}/plots/improvedNMHH/tridDixonprice.png')