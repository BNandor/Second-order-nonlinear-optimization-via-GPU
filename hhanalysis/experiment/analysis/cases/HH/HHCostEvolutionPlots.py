...
methods=[     
                ...
                #   (MADS_NMHH_GA_DE_GD_LBFGS_GWO_EXPERIMENT_RECORDS_PATH,"MADS"),
                  ...
                  (CUSTOMHYS2_RESULTS_PATH,"CustomyS",{"customDF":customhys.loadCustomHyS2.loadCustomHysDF(),
...
createMethodsCostEvolutionPlots(methods,problems,performanceMapping,filter,filename=f'{ROOT}/plots/lod2023/qing.svg')